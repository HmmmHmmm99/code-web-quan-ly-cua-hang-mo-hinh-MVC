			...
			<div class="span12">
				<div class="table-toolbar">
					...
					<div id="productnew" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="true" style="display: none;">
					  ...
					  <!-- TESSSS -->
					  <s:form id="uploadImage" class="form-horizontal" action="/admin/upload" method="post" enctype="multipart/form-data" modelAttribute="itemSale" >
							<!-- <div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div> -->
							<div class="modal-body">
								<div class="form-group">
									<label class="col-md-3 control-label">Upload File(AWS) :</label>
									<div class="col-md-6">
						...
						<%-- <s:form class="form-horizontal loginFrm" action="${pageContext.request.contextPath }/add-sale" modelAttribute="item" enctype="multipart/form-data" method="POST">
